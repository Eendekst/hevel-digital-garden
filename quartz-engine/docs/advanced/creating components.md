...
Then, you can use it like any other component in `quartz.layout.ts` via `Component.YourComponent()`. See the [[Vault/Research/Money/docs/Configuration#Layout|layout]] section for more details.
