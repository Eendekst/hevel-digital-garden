...
> [!hint]
> Some Quartz features (like [[RSS Feed]] and sitemap generation) require `baseUrl` to be configured properly in your [[Mobile/BRAND/Garden/quartz-engine/docs/configuration]] to work properly. Make sure you set this before deploying!
