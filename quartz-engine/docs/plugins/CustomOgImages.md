...
> [!info] Info
>
> The `baseUrl` property in your [[Vault/Research/Money/docs/Configuration]] must be set properly for social images to work correctly, as they require absolute paths.
